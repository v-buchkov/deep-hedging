...
from deep_hedging.deep_hedging.utils.annuity import annuity_factor

from deep_hedging.deep_hedging.base.instrument import Instrument
from deep_hedging.deep_hedging.curve.yield_curve import YieldCurve
...
class RiskFreeBond(Instrument):
    ...
    def coupon(self, frequency: float = 0., *args, **kwargs) -> float:
        if frequency > 0:
            ...
            return self.pv_coupons() / annuity_factor(annual_rate=annual_rate, frequency=frequency,
