...
from deep_hedging.dl.train_texts import train_epoch, validation_epoch, plot_losses
...
class TrainerTexts:
    ...
    def _get_dataloaders(
        self, train_set: SpotDatasetTexts, test_set: SpotDatasetTexts
    ...
    ) -> Tuple[SpotDatasetTexts, SpotDatasetTexts]:
